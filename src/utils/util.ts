...
// const datavRecentFlatColorsKey = 'datavRecentFlatColors'
// export const getDatavRecentFlatColors = (key = datavRecentFlatColorsKey) => {
//   try {
...
//   return null
// }
// export const setDatavRecentFlatColors = debounce((key = datavRecentFlatColorsKey,value) => {
//   var data = getDatavRecentFlatColors(key)
//   if(data.length<=20){
//     data.push(value)
//   }else{
//     data.pop().unshift(value)
//   }
