...
<script lang='ts'>
import { h, defineComponent, ref, computed, provide, onMounted, Ref } from 'vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectedGroupId:Ref<string|number> = ref('-1')
    ...
    const toggleProject = (id: number | string) => {
