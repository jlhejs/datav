...
Cube(
  "datav:/com/qrcode/0.0.6",
  [
    "datav:/npm/bcore/0.0.18/event",
    "datav:/npm/jquery/2.1.4",
    "datav:/npm/lodash/4.6.1",
    "datav:/npm/qrcodejs2/0.0.2",
  ],
  function (t, e, i, r, o, a) {
    var n = i("datav:/npm/bcore/0.0.18/event"),
      s = i("datav:/npm/jquery/2.1.4"),
      A = i("datav:/npm/lodash/4.6.1"),
      H = i("datav:/npm/qrcodejs2/0.0.2");
    return (
      (t.exports = n.extend(
        function (t, e) {
          (this.config = { theme: {} }),
        ...
        },
        {
          ...
          listenerImgCb: function (t) {
            ...
            "IMG" !== e.nodeName.toUpperCase() ||
              A.isNull(t) ||
              (t >= this.THREE
                ? (e.src = this.base64Img)
                : ((e.src =
                    "https://private-alipayobjects.alipay.com/alipay-rmsdeploy-image/skylark/avatar/6990e17e-6f3e-4075-9b8f-d2faa61e056c.gif?x-oss-process=image%2Fresize%2Cm_fill%2Cw_90%2Ch_90%2Fformat%2Cpng"),
                  e.setAttribute("data-retry-num", (t += 1))));
          },
          ...
          render: function (t, e) {
            ...
            var i = this.mergeConfig(e),
              ...
              imgBox = this.container.find(".img-box"),
              d = imgBox.find("img"),
              h = i.text,
              c = i.color,
              l = c.colorDark,
            ...
            imgBox.css({
              ...
              d.css({ width: y + "px", height: v + "px", "border-radius": m + "px" }),
              d.attr("src", logoImage),
              n && n.empty(),
              this.qrcode && this.qrcode.clear(),
              (this.qrcode = new H(n[0], {
                text: h,
                width: o - 2 * b,
                height: a - 2 * b,
                colorDark: l,
          ...
          resize: function (t, e) {
            (this.containSize = { boxWidth: t, boxHeight: e }),
          ...
          getThemableConfig: function (t) {
            ...
            var e = t.textColor,
              ...
              t = "";
            return (
              i && i.length && (i[A.floor(i.length / 2)], (t = i[0])),
              { color: { colorDark: t, colorLight: e } }
            );
          },
          mergeConfig: function (t) {
            return (
              t &&
                ((this.config.theme = A.defaultsDeep(t.theme || {}, this.config.theme)),
                this.setColors(),
                (this.config = A.defaultsDeep(t || {}, this.config))),
              this.config
            );
          },
