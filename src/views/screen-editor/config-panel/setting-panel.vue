    ...
    <div class="setting-panel-content">
      <div class="scroll-container">
        ...
        <component
          ...
          :com="com"
        />
        <custom-setting-panel v-else v-model="com.config" v-model:config="config" />
      </div>
    </div>
  </div>
</template>
...
import CustomSettingPanel from './custom-setting-panel/index.vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const hasSettingCom = !!getCurrentInstance().appContext.components[`${com.value.name  }Prop`]
    const toSearch = () => {
