...
export const useMock = async () => {
  ...
  const names = ['VMainTitle', 'VNumberTitleFlop', 'VDatePicker', 'DatavBgBox', 'VBorderBox', 'VDecoration', 'VBasicBar', 'VMarquee', 'VParagraph', 'VTimer', 'VFullScreen', 'VMainImg', 'VWordCloud']
